...
//#endif
	...
	//projection = glm::ortho(-10.0, 10.0, -10.0, 10.0, -10.0, 1.0); //EXERCICIO 1 - LISTA 2
	projection = glm::ortho(0.0, 800.0, 0.0, 600.0, -1.0, 1.0); //EXERCICIO 1 - LISTA 2
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		...
		// 0.5,  0.5, 0.0, //v2 
		 ...
		 //x   y     z
		-0.5,  0.45,  0.0,  1.0, 1.0, 0.0, //v0
		-0.5, -0.5 ,  0.0,	0.0, 1.0, 1.0, //v1
