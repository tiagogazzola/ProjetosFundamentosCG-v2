...
//Variavel para o tamanho do circulo
const int multiplayer = 2;
const int nPoints = 8 * multiplayer; // O PRIMEIRO VALOR É O NUMERO DE LADOS PARA O CIRCULO
...
int setupGeometry()
{
	...
	float angle = 0.0f;
	float slice = 2.0f * 3.14159265359f / nPoints; // Use o valor correto de PI
	float radius = 0.5f;
